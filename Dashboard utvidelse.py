...
# Teller og sender en counter til en feed som heter 'counter' på adafruit.
    ...
    if analog_value >0.5:
        ...
        digital_output3.write(False) # Hvis potmeter verdien er over 0,5 vil lys 2 lyse og lys 3 være av
    else:
        digital_output2.write(False)
        digital_output3.write(True) # Hvis potmeter verdien er under 0,5 vil lys 3 lyse og lys 2 være av
    time.sleep(3)
